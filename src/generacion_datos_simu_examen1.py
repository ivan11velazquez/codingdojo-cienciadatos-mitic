...
platform = np.random.choice(['Android', 'iOS', 'anDROId', 'ios', 'Ps5', 'XboX'], 300)
session_duration = np.random.randint(1, 1440, 300)
number_of_sessions = np.random.randint(1, 1440, 300)
country = np.random.choice(['USA', 'Canada', 'Mexico', 'UK', 'Germany', 'France', 'Spain', 'Italy'], 300)
user_feedback = np.random.randint(0, 10, 300)
